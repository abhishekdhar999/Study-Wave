...
<nav className="bg-white border-gray-200 ">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
    <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
        <img  src={logoBlack}className="h-16 w-[85px] " alt="Flowbite Logo" />
        <span className="logoeffect self-center text-2xl font-bold whitespace-nowrap dark:text-black font-serif">The Study Wave</span>
    </a>
    ...
    {isOpen && <div className=" w-full md:block md:w-auto" id="navbar-default">
      <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 ">
        ...
        <li>
          <Link to="/explorepage">
          <a href="/explorepage" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-black md:dark:hover:text-blue-500 dark:hover:text-white md:dark:hover:bg-transparent">Explore</a>
          </Link>
        </li>
        <li>
    ...
    <div className="shift hidden w-full md:block md:w-auto" id="navbar-default">
      <ul className="font-medium flex flex-col p-6 md:p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white  mx-6 ">
        <li>
        ...
        <li>
        <Link to="/explorepage">
          <a href="/explorepage" className="custom-button block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-black md:dark:hover:text-blue-500 dark:hover:text-white md:dark:hover:bg-transparent  font-serif font-bold">Explore</a>
          </Link>
        </li>
        <li>
          <a href="/" className="custom-button block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0  md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent font-serif font-bold">Pricing</a>
        </li>
        <li>
